...
export const createCeiling = (scene, textureLoader) => {
  ...
  const colorTexture = textureLoader.load(
    "OfficeCeiling005_1K-JPG/OfficeCeiling005_1K-JPG_Color.jpg"
  );
  const displacementTexture = textureLoader.load(
    "OfficeCeiling005_1K-JPG/OfficeCeiling005_1K-JPG_Displacement.jpg"
  );
  const aoTexture = textureLoader.load(
    "OfficeCeiling005_1K-JPG/OfficeCeiling005_1K-JPG_AmbientOcclusion.jpg"
  );
  const emissionTexture = textureLoader.load(
    "OfficeCeiling005_1K-JPG/OfficeCeiling005_1K-JPG_Emission.jpg"
  );
  const metalnessTexture = textureLoader.load(
    "OfficeCeiling005_1K-JPG/OfficeCeiling005_1K-JPG_Metalness.jpg"
  );
  const normalGLTexture = textureLoader.load(
    "OfficeCeiling005_1K-JPG/OfficeCeiling005_1K-JPG_NormalGL.jpg"
  );
  const roughnessTexture = textureLoader.load(
    "OfficeCeiling005_1K-JPG/OfficeCeiling005_1K-JPG_Roughness.jpg"
  );
